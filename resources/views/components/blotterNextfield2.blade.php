...
<!-- Modal toggle -->
<button hidden data-modal-target="nextblotter2" data-modal-toggle="nextblotter2" class="" type="button">
  Toggle modal
</button>

<!-- Main modal -->
<div id="nextblotter2" tabindex="-1" aria-hidden="true" class="hidden overflow-y-auto overflow-x-hidden fixed top-0 right-0 left-0 z-50 justify-center items-center w-full md:inset-0 h-[calc(100%-1rem)] max-h-full">
...
<ol class="flex items-center w-full">
    ...
    <li class="flex items-center w-full">
        <span class="flex items-center justify-center w-10 h-10 bg-gray-100 rounded-full lg:h-12 lg:w-12 dark:bg-gray-700 shrink-0">
            ...
            <label for="" data-modal-hide="crud-modal">
                <button type="button" data-modal-hide="nextblotter" class="text-gray-400 bg-transparent hover:bg-gray-200 hover:text-gray-900 rounded-lg text-sm w-8 h-8 ms-auto inline-flex justify-center items-center dark:hover:bg-gray-600 dark:hover:text-white" data-modal-toggle="nextblotter2">
            ...
            <form class="p-4 md:p-5">
                ...
                <div class=" w-full space-x-8 flex mt-32 md:mt-0 md:justify-center">
                <button data-modal-hide="nextblotter2" data-modal-target="nextblotter" data-modal-toggle="nextblotter" type="Button" class="text-white inline-flex items-center bg-blue-700 hover:bg-blue-800 focus:ring-4 focus:outline-none focus:ring-blue-300 font-medium rounded-lg text-sm px-5 py-2.5 text-center dark:bg-blue-600 dark:hover:bg-blue-700 dark:focus:ring-blue-800">
                    Back
                </button>
