...
<!-- Modal toggle -->
<button hidden data-modal-target="blotterSuspec" data-modal-toggle="blotterSuspec" class="" type="button">
  Toggle modal
</button>
<meta name="csrf-token" content="{{ csrf_token() }}">
<script src="https://code.jquery.com/jquery-3.6.0.min.js"></script>
<!-- Main modal -->
<div id="blotterSuspec" tabindex="-1" aria-hidden="true" class="hidden overflow-y-auto overflow-x-hidden fixed top-0 right-0 left-0 z-50 justify-center items-center w-full md:inset-0 h-[calc(100%-1rem)] max-h-full">
    <div class="relative p-4 w-full max-w-2xl  max-h-full">
        ...
        <div class="relative bg-white rounded-lg shadow dark:bg-gray-700">
            ...
            <div class="flex items-center justify-between p-4 md:p-5 border-b rounded-t dark:border-gray-600">
                ...
                <button type="button" data-modal-hide="nextblotter" class="text-gray-400 bg-transparent hover:bg-gray-200 hover:text-gray-900 rounded-lg text-sm w-8 h-8 ms-auto inline-flex justify-center items-center dark:hover:bg-gray-600 dark:hover:text-white" data-modal-toggle="blotterSuspec">
    ...
    <ul class="flex flex-wrap -mb-px text-sm font-medium text-center" id="default-styled-tab1" data-tabs-toggle="#default-styled-tab-content1" data-tabs-active-classes="text-purple-600 hover:text-purple-600 dark:text-purple-500 dark:hover:text-purple-500 border-purple-600 dark:border-purple-500" data-tabs-inactive-classes="dark:border-transparent text-gray-500 hover:text-gray-600 dark:text-gray-400 border-gray-100 hover:border-gray-300 dark:border-gray-700 dark:hover:text-gray-300" role="tablist">
        <li class="me-2" role="presentation">
            <button class="inline-block p-4 border-b-2 rounded-t-lg" id="profile-styled-tab1" data-tabs-target="#styled-profile1" type="button" role="tab" aria-controls="profile1" aria-selected="false">First</button>
        </li>
        <li class="me-2" role="presentation">
            <button class="inline-block p-4 border-b-2 rounded-t-lg hover:text-gray-600 hover:border-gray-300 dark:hover:text-gray-300" id="dashboard-styled-tab" data-tabs-target="#styled-dashboard1" type="button" role="tab" aria-controls="dashboard" aria-selected="false">Second</button>
        </li>
        <li class="me-2" role="presentation">
            <button class="inline-block p-4 border-b-2 rounded-t-lg hover:text-gray-600 hover:border-gray-300 dark:hover:text-gray-300" id="settings-styled-tab" data-tabs-target="#styled-settings1" type="button" role="tab" aria-controls="settings" aria-selected="false">third</button>
        </li>
        <li role="presentation">
            <button class="inline-block p-4 border-b-2 rounded-t-lg hover:text-gray-600 hover:border-gray-300 dark:hover:text-gray-300" id="contacts-styled-tab" data-tabs-target="#styled-contacts1" type="button" role="tab" aria-controls="contacts" aria-selected="false">fourth</button>
        </li>
        <li role="presentation">
            <button class="inline-block p-4 border-b-2 rounded-t-lg hover:text-gray-600 hover:border-gray-300 dark:hover:text-gray-300" id="contacts-styled-tab" data-tabs-target="#styled-fifth1" type="button" role="tab" aria-controls="fifth" aria-selected="false">fifth</button>
        </li>
    </ul>
</div>
  ...
  <path d="M2 2a2 2 0 0 0-2 2v8a2 2 0 0 0 2 2h12a2 2 0 0 0 2-2V4a2 2 0 0 0-2-2zM1 4a1 1 0 0 1 1-1h12a1 1 0 0 1 1 1v8a1 1 0 0 1-1 1H8.96q.04-.245.04-.5C9 10.567 7.21 9 5 9c-2.086 0-3.8 1.398-3.984 3.181A1 1 0 0 1 1 12z"/>
    ...
    <li class="flex items-center w-full">
        <span class="flex items-center justify-center w-10 h-10 bg-gray-100 rounded-full lg:h-12 lg:w-12 dark:bg-gray-700 shrink-0">
            ...
            <x-blotterDrawer />
            <div id="default-styled-tab-content" >
    <div class="hidden p-4 rounded-lg bg-gray-50 dark:bg-gray-700" id="styled-profile1" role="tabpanel" aria-labelledby="profile-tab">
...
<div class="col-span-2 sm:col-span-1 ">
  ...
  <div class="flex items-center mb-4">
    ...
    <div class="hidden p-4 rounded-lg bg-gray-50 dark:bg-gray-700" id="styled-dashboard1" role="tabpanel" aria-labelledby="dashboard-tab">
    ...
    <div class="hidden p-4 rounded-lg bg-gray-50 dark:bg-gray-700" id="styled-settings1" role="tabpanel" aria-labelledby="settings-tab">
    <div class="grid gap-4 mb-4 grid-cols-2">
                <div class="col-span-2">
    ...
    <div class="hidden p-4 rounded-lg bg-gray-50 dark:bg-gray-700" id="styled-contacts1" role="tabpanel" aria-labelledby="contacts-tab">
    <div class="grid gap-4 mb-4 grid-cols-2">
                ...
                <div class="col-span-2 sm:col-span-1">
                    <label id="lMother" for="Mother" class="block mb-2 text-sm font-medium text-gray-900 dark:text-white">WORK ADDRESS</label>
                    <input type="text" name="Mother" id="Mother" class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-primary-600 focus:border-primary-600 block w-full p-2.5 dark:bg-gray-600 dark:border-gray-500 dark:placeholder-gray-400 dark:text-white dark:focus:ring-primary-500 dark:focus:border-primary-500"  required="">
                </div>
                <div class="col-span-2 sm:col-span-1">
                    <label id="lMother" for="Mother" class="block mb-2 text-sm font-medium text-gray-900 dark:text-white">RELATION TO VICTIM</label>
    ...
    <div class="hidden p-4 rounded-lg bg-gray-50 dark:bg-gray-700" id="styled-fifth1" role="tabpanel" aria-labelledby="contacts-tab">
    <div class="grid gap-4 mb-4 grid-cols-2">
                
                <div class="col-span-2">
                    <label id="lFather" for="Father" class="block mb-2 text-sm font-medium text-gray-900 dark:text-white">IF AFR/PNP PERSONAL:RANK</label>
                    <input type="text" name="Father" id="Father" class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-primary-600 focus:border-primary-600 block w-full p-2.5 dark:bg-gray-600 dark:border-gray-500 dark:placeholder-gray-400 dark:text-white dark:focus:ring-primary-500 dark:focus:border-primary-500" placeholder="" required="">
                </div>
                
                <div class="col-span-2 sm:col-span-1">
                    <label id="lMother" for="Mother" class="block mb-2 text-sm font-medium text-gray-900 dark:text-white">UNIT ASSIGNMENT</label>
                    <input type="email" name="Mother" id="Mother" class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-primary-600 focus:border-primary-600 block w-full p-2.5 dark:bg-gray-600 dark:border-gray-500 dark:placeholder-gray-400 dark:text-white dark:focus:ring-primary-500 dark:focus:border-primary-500" placeholder="" required="">
                </div>
                <div class="col-span-2 sm:col-span-1">
                    <label id="lMother" for="Mother" class="block mb-2 text-sm font-medium text-gray-900 dark:text-white">GROUP AFFILIATION</label>
                    <input type="email" name="Mother" id="Mother" class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-primary-600 focus:border-primary-600 block w-full p-2.5 dark:bg-gray-600 dark:border-gray-500 dark:placeholder-gray-400 dark:text-white dark:focus:ring-primary-500 dark:focus:border-primary-500" placeholder="" required="">
                </div>
                <div class="col-span-2 sm:col-span-1">
                    <label id="lMother" for="Mother" class="block mb-2 text-sm font-medium text-gray-900 dark:text-white">WITH PREVIOUS CRIMINAL RECORDS?</label>
                    <input type="email" name="Mother" id="Mother" class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-primary-600 focus:border-primary-600 block w-full p-2.5 dark:bg-gray-600 dark:border-gray-500 dark:placeholder-gray-400 dark:text-white dark:focus:ring-primary-500 dark:focus:border-primary-500" placeholder="yes or no" required="">
                </div>
                <div class="col-span-2 sm:col-span-1">
                    <label id="lMother" for="Mother" class="block mb-2 text-sm font-medium text-gray-900 dark:text-white">STATUS OF PREVIOUS CASE</label>
                    <input type="email" name="Mother" id="Mother" class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-primary-600 focus:border-primary-600 block w-full p-2.5 dark:bg-gray-600 dark:border-gray-500 dark:placeholder-gray-400 dark:text-white dark:focus:ring-primary-500 dark:focus:border-primary-500" placeholder="" required="">
                </div>
                <div class="col-span-2 sm:col-span-1">
                    <label id="lMother" for="Mother" class="block mb-2 text-sm font-medium text-gray-900 dark:text-white">HEIGHT(CM)</label>
                    <input type="email" name="Mother" id="Mother" class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-primary-600 focus:border-primary-600 block w-full p-2.5 dark:bg-gray-600 dark:border-gray-500 dark:placeholder-gray-400 dark:text-white dark:focus:ring-primary-500 dark:focus:border-primary-500" placeholder="" required="">
                </div>
                <div class="col-span-2 sm:col-span-1">
                    <label id="lMother" for="Mother" class="block mb-2 text-sm font-medium text-gray-900 dark:text-white">WEIGHT (KG)</label>
                    <input type="email" name="Mother" id="Mother" class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-primary-600 focus:border-primary-600 block w-full p-2.5 dark:bg-gray-600 dark:border-gray-500 dark:placeholder-gray-400 dark:text-white dark:focus:ring-primary-500 dark:focus:border-primary-500" placeholder="" required="">
                </div>
                <div class="col-span-2 ">
                    <label id="lMother" for="Mother" class="block mb-2 text-sm font-medium text-gray-900 dark:text-white">COLORS OF EYES</label>
                    <input type="email" name="Mother" id="Mother" class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-primary-600 focus:border-primary-600 block w-full p-2.5 dark:bg-gray-600 dark:border-gray-500 dark:placeholder-gray-400 dark:text-white dark:focus:ring-primary-500 dark:focus:border-primary-500" placeholder="" required="">
                </div>
                <div class="col-span-2 ">
                    <label id="lMother" for="Mother" class="block mb-2 text-sm font-medium text-gray-900 dark:text-white">DESCRIPTION OF EYES</label>
                    <input type="email" name="Mother" id="Mother" class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-primary-600 focus:border-primary-600 block w-full p-2.5 dark:bg-gray-600 dark:border-gray-500 dark:placeholder-gray-400 dark:text-white dark:focus:ring-primary-500 dark:focus:border-primary-500" placeholder="" required="">
                </div>
                <div class="col-span-2 ">
                    <label id="lMother" for="Mother" class="block mb-2 text-sm font-medium text-gray-900 dark:text-white">COLOR OF HAIR</label>
                    <input type="email" name="Mother" id="Mother" class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-primary-600 focus:border-primary-600 block w-full p-2.5 dark:bg-gray-600 dark:border-gray-500 dark:placeholder-gray-400 dark:text-white dark:focus:ring-primary-500 dark:focus:border-primary-500" placeholder="" required="">
                </div>
                <div class="col-span-2 ">
                    <label id="lMother" for="Mother" class="block mb-2 text-sm font-medium text-gray-900 dark:text-white">DESCRIPTION OF HAIR</label>
                    <input type="email" name="Mother" id="Mother" class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-primary-600 focus:border-primary-600 block w-full p-2.5 dark:bg-gray-600 dark:border-gray-500 dark:placeholder-gray-400 dark:text-white dark:focus:ring-primary-500 dark:focus:border-primary-500" placeholder="" required="">
                </div>
                <div class="col-span-2 ">
                    <label id="lMother" for="Mother" class="block mb-2 text-sm font-medium text-gray-900 dark:text-white">UNDER THE INFUENCE OF ?</label>
                    <input type="email" name="Mother" id="Mother" class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-primary-600 focus:border-primary-600 block w-full p-2.5 dark:bg-gray-600 dark:border-gray-500 dark:placeholder-gray-400 dark:text-white dark:focus:ring-primary-500 dark:focus:border-primary-500" placeholder="" required="">
                </div>
