...
<button id="dropdownNotificationButton" data-dropdown-toggle="dropdownNotification" class="relative inline-flex items-center text-sm font-medium text-center text-white hover:text-gray-900 focus:outline-none dark:hover:text-white dark:text-gray-400" type="button">
<svg class="w-5 h-5" aria-hidden="true" xmlns="http://www.w3.org/2000/svg" fill="currentColor" viewBox="0 0 14 20">
<path d="M12.133 10.632v-1.8A5.406 5.406 0 0 0 7.979 3.57.946.946 0 0 0 8 3.464V1.1a1 1 0 0 0-2 0v2.364a.946.946 0 0 0 .021.106 5.406 5.406 0 0 0-4.154 5.262v1.8C1.867 13.018 0 13.614 0 14.807 0 15.4 0 16 .538 16h12.924C14 16 14 15.4 14 14.807c0-1.193-1.867-1.789-1.867-4.175ZM3.823 17a3.453 3.453 0 0 0 6.354 0H3.823Z"/>
</svg>

<div id="notifycounted">
...
<div id="dropdownNotification" class="z-20 hidden w-full max-w-sm bg-white divide-y divide-gray-100 rounded-lg shadow dark:bg-gray-800 dark:divide-gray-700" aria-labelledby="dropdownNotificationButton">
  ...
  <div class="divide-y overflow-scroll hide-scrollbar higtnotify border border-gray-300 divide-gray-100 dark:divide-gray-700 max-w-md">

  <div id="notifysender" class="notify"></div>

    <a hidden href="#" class="hidden flex px-4 py-3 hover:bg-gray-100 dark:hover:bg-gray-700">
      ...
      <div class="w-full ps-3">
          <div class="text-gray-500 text-sm mb-1.5 dark:text-gray-400">New message from <span class="font-semibold text-gray-900 dark:text-white">John Legend</span>: "Hey, what's up? All set for the presentation?"</div>
    ...
    <a hidden href="#" class="hidden flex px-4 py-3 hover:bg-gray-100 dark:hover:bg-gray-700">
      ...
      <div class="w-full ps-3">
          <div class="text-gray-500 text-sm mb-1.5 dark:text-gray-400"><span class="font-semibold text-gray-900 dark:text-white">Justin Bieber</span> and <span class="font-medium text-gray-900 dark:text-white">5 others</span> started following you.</div>
    ...
    <a hidden href="#" class="hidden flex px-4 py-3 hover:bg-gray-100 dark:hover:bg-gray-700">
      ...
      <div class="w-full ps-3">
          <div class="text-gray-500 text-sm mb-1.5 dark:text-gray-400"><span class="font-semibold text-gray-900 dark:text-white">Manok Na Pula</span> and <span class="font-medium text-gray-900 dark:text-white">141 others</span> love your story. See it and view more stories.</div>
    ...
    <a hidden href="#" class="hidden flex px-4 py-3 hover:bg-gray-100 dark:hover:bg-gray-700">
      ...
      <div class="w-full ps-3">
          <div class="text-gray-500 text-sm mb-1.5 dark:text-gray-400"><span class="font-semibold text-gray-900 dark:text-white">Liza soberano</span> mentioned you in a comment: <span class="font-medium text-blue-500" href="#">@Adele.Suyop</span> I love You Too Baby❤️❤️❤️❤️</div>
    ...
    <a hidden href="#" class="hidden flex px-4 py-3 hover:bg-gray-100 dark:hover:bg-gray-700">
      ...
      <div class="w-full ps-3">
          <div class="text-gray-500 text-sm mb-1.5 dark:text-gray-400"><span class="font-semibold text-gray-900 dark:text-white">Adele</span> posted a new video: Glassmorphism - learn how to implement the new design trend.</div>
