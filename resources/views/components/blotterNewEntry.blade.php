...
<label for="" data-modal-hide="nextblotter2">
                <button type="button" data-modal-hide="nextblotter" class="text-gray-400 bg-transparent hover:bg-gray-200 hover:text-gray-900 rounded-lg text-sm w-8 h-8 ms-auto inline-flex justify-center items-center dark:hover:bg-gray-600 dark:hover:text-white" data-modal-toggle="crud-modal">
            ...
            <!-- Modal body -->
            <form id="Newform1" class="p-4 md:p-5">
            @csrf
